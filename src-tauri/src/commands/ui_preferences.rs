...
pub async fn get_color_theme_cmd(
    ...
    crate::observability::command::observe("get_color_theme_cmd", async {
...
pub async fn set_color_theme_cmd(
    ...
    crate::observability::command::observe("set_color_theme_cmd", async {
        Ok(usecases
            .ui_preferences
...
pub async fn import_color_theme_cmd(
    ...
    crate::observability::command::observe("import_color_theme_cmd", async {
...
pub async fn get_project_pins_cmd(
    ...
    crate::observability::command::observe("get_project_pins_cmd", async {
...
pub async fn set_project_pin_cmd(
    ...
    crate::observability::command::observe("set_project_pin_cmd", async {
        Ok(usecases
            .ui_preferences
...
pub async fn import_project_pins_cmd(
    ...
    crate::observability::command::observe("import_project_pins_cmd", async {
        let entries = entries
            .into_iter()
