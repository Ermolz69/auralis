...
- **Variants/states:** idle, pending, running, cancelling, completed, error, cancelled; active/selected/locked; loading spinners; empty queue/project list; hover/focus/disabled; determinate and indeterminate progress.
