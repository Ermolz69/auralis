    ...
    segments: [
      {
        ...
        startMs: 1200,
        endMs: 7450,
        sourceText: 'Добро пожаловать в подробный разбор нейросетевого синтеза звука.',
      },
      {
        id: 'ru-2',
        index: 1,
        startMs: 8100,
        endMs: 12880,
        sourceText: 'Мы рассмотрим современные системы преобразования текста в речь.',
      },
      {
        id: 'ru-3',
        index: 2,
        startMs: 13200,
        endMs: 18560,
        sourceText: 'Начнём с основ акустического моделирования.',
      },
    ],
  },
  'youtube-ready': {
