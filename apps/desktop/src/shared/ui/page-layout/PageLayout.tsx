...
export const PageHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = '', ...props }, ref) => (
    <div ref={ref} className={`flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 shrink-0 ${className}`} {...props} />
  )
);
PageHeader.displayName = 'PageHeader';

export const PageHeaderGroup = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = '', ...props }, ref) => (
...
export const PageTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className = '', ...props }, ref) => (
    <h1 ref={ref} className={`text-2xl font-bold tracking-tight text-text sm:text-3xl ${className}`} {...props} />
  )
);
...
export const PageLayoutWithSidebar = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = '', ...props }, ref) => (
    <div ref={ref} className={`flex flex-col md:flex-row gap-8 lg:gap-12 w-full flex-1 ${className}`} {...props} />
  )
);
...
export const PageSidebar = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = '', ...props }, ref) => (
    <aside ref={ref} className={`w-full md:w-64 lg:w-80 shrink-0 flex flex-col gap-4 ${className}`} {...props} />
  )
);
PageSidebar.displayName = 'PageSidebar';

// Main content area for the two-column layout
export const PageSidebarContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className = '', ...props }, ref) => (
